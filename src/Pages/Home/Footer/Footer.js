...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-info rounded-lg dark:text-gray-100">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">© Resale BD. All rights reserved.</div>
        </footer>
    );
};
