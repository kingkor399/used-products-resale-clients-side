...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://products-resale-server-side.vercel.app/category/${params.id}`)
            },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://products-resale-server-side.vercel.app/bookings/${params.id}`)
            },
